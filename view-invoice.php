...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/view-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:50 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="view-invoice.html" class="active-sub">View Invoice</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">View Invoice</h5>
            <!-- Page title ends -->
                  ...
                  <div class="card-body">
                    ...
                    <div class="row gx-3 align-items-center">
                      <div class="col-sm-3 col-12">
                        <img src="assets/images/logo.svg" alt="Bootstrap Admin Dashboard" class="invoice-logo">
                      </div>
                      <div class="col-sm-9 col-12">
                        <p class="text-end m-0">
                          Admini Inc, 5678 St. <br>
                          2900 Church Street, Suite 900<br>
                    ...
                    <div class="row gx-4">
                      <div class="col-12">
                        <div class="d-flex justify-content-between my-4">
                          ...
                          <div>
                            <p class="m-0">Invoice - #222</p>
                            <p class="m-0">January 2024</p>
                          ...
                          <div class="table-responsive">
                            <table class="table truncate">
                              ...
                              <tbody>
                                <tr>
                                  <td>
                                    <h5 class="mb-1">Best Admin Template</h5>
                                    <p class="m-0">
                                ...
                                <tr>
                                  <td>
                                    <h5 class="mb-1">Premium Admin Dashboards</h5>
                                    <p class="m-0">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <p class="mb-1">VAT</p>
                                    <h5 class="mt-4 text-info">Total USD</h5>
                                  </td>
                                  <td>
                                    <p class="mb-1">$1000.00</p>
                                    <p class="mb-1">$10.00</p>
                                    <p class="mb-1">$5.00</p>
                                    <h5 class="mt-4 text-success">$1015.00</h5>
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="4">
