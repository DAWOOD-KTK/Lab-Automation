...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:42 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Reviews</h5>
            <!-- Page title ends -->
                      ...
                      <div class="table-responsive">
                        <table class="table align-middle">
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <img src="assets/images/user5.png" class="img-3xx rounded-3" alt="Admin Dashboards">
                              </td>
                              <td>Juilea Rye</td>
                              <td>
                                Bootstrap Gallery - Admin Dashboard Template. Hight Code Quality. Minimalistic & blazing
                                fast. Worth 100 times of its offering price.
                              </td>
                              <td>01/14/2024</td>
                              <td>
                                <span class="badge bg-primary-subtle text-primary">485908</span>
                              </td>
                              <td>
                            ...
                            <tr>
                              <td>
                                <img src="assets/images/user4.png" class="img-3xx rounded-3" alt="Admin Dashboards">
                              </td>
                              <td>Kelly williams</td>
                              <td>
                                Bootstrap Gallery Admin Templates are fully-featured Bootstrap 5 admin template
                                featuring a
                                clean, simple, and professional design.
                              </td>
                              <td>01/12/2024</td>
                              <td>
                                <span class="badge bg-primary-subtle text-primary">219905</span>
                              </td>
                              <td>
                            ...
                            <tr>
                              <td>
                                <img src="assets/images/user3.png" class="img-3xx rounded-3" alt="Admin Dashboards">
                              </td>
                              <td>Yeyara Joshoumn</td>
                              <td>
                                Bootstrap Gallery is a HTML5 Bootstrap 5 developer-friendly fully responsive highly
                                customizable admin template that is
                                compatible with any screen.
                              </td>
                              <td>12/01/2024</td>
                              <td>
                                <span class="badge bg-primary-subtle text-primary">980998</span>
                              </td>
                              <td>
                                <div class="readonly4 rating-stars"></div>
                              </td>
                            ...
                            <tr>
                              <td>
                                <img src="assets/images/user2.png" class="img-3xx rounded-3" alt="Admin Dashboards">
                              </td>
                              <td>Aneora Hamilton</td>
                              <td>
                                Bootstrap Gallery Admin Templates have masterfully combined the benefits of both
                                resources with their own design vision.
                              </td>
                              <td>10/01/2024</td>
                              <td>
                                <span class="badge bg-primary-subtle text-primary">332428</span>
                              </td>
                              <td>
                                <div class="readonly5 rating-stars"></div>
                              </td>
                            ...
                            <tr>
                              <td>
                                <img src="assets/images/user.png" class="img-3xx rounded-3" alt="Admin Dashboards">
                              </td>
                              <td>Zooyara Plings</td>
                              <td>
                                It's very user-friendly and the design is great. The templates provided are high quality
                                and make creating a site easy and straightforward.
                              </td>
                              <td>04/01/2024</td>
                              <td>
                                <span class="badge bg-primary-subtle text-primary">663324</span>
                              </td>
                              <td>
                                <div class="readonly5 rating-stars"></div>
                              </td>
...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:43 GMT -->
</html>