...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/form-accordion.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:40 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="form-accordion.html" class="active-sub">Form Accordion</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Form Accordion</h5>
            <!-- Page title ends -->
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5 class="card-title">Form Accordion</h5>
                  </div>
                  <div class="card-body">
                            ...
                            <div class="row gx-4">
                              ...
                              <div class="col-sm-12 col-12">
                                <div class="mb-3">
                                  ...
                                  <textarea class="form-control" id="msg" placeholder="Enter message"
                                    rows="3"></textarea>
                                </div>
                              </div>
                              <div class="col-sm-12 col-12">
