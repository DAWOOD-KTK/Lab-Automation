...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:32 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="typography.html" class="active-sub">Typography</a>
                  </li>
                </ul>
              </li>
              <li class="treeview">
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Typography</h5>
            <!-- Page title ends -->
          ...
          <div class="app-body">
            ...
            <div class="row gx-4">
              ...
              <div class="col-lg-6 col-sm-12 col-12">
                <div class="card mb-4">
                  <div class="card-body">
                    <h1 class="mb-3 text-primary">h1. Admin Heading</h1>
              ...
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Left Aligned</h5>
                  </div>
                  <div class="card-body">
                    <div class="p-3">
                      <div class="row flex-lg-row-reverse align-items-center">
                        <div class="col-10 col-sm-8 col-lg-6">
                          <div class="mt-4">
                            <img src="assets/images/thumbs/img5.jpg" class="d-block mx-lg-auto img-fluid rounded-5"
                              alt="Admin Templates &amp; Dashboards">
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <h1 class="display-5">
                          ...
                          <p class="lead mb-4">
                            Searching for free or premium HTML5 dashboard templates? Download responsive HTML5 CSS3
                            Admin Dashboard Templates. Free for personal and commercial use. Designed and Developed by
                            Bootstrap Gallery.
                          </p>
            ...
            <div class="row gx-4">
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Centered Hero</h5>
                  </div>
                  <div class="card-body">
                    <div class="p-5 text-center">
                      ...
                      <div class="col-lg-6 mx-auto">
                        ...
                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                          <button type="button" class="btn btn-outline-dark btn-lg">Button</button>
                  ...
                  <div class="card-body">
                    <div class="p-5 text-center">
                      ...
                      <div class="col-lg-6 mx-auto">
                        ...
                        <div class="mt-4">
                          <img src="assets/images/thumbs/img10.jpg" class="img-fluid rounded-5 mb-4"
                            alt="Admin Templates &amp; Dashboards">
                        </div>
                      </div>
                    </div>
            ...
            <div class="row gx-4">
              ...
              <div class="col-sm-12">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <p class="lh-1">
                      Download the best Admin & Dashboard Templates developed by Bootstrap Gallery. Join over 55,895
                      creatives that already love our bootstrap resources!
                    </p>
                    <p class="lh-sm">
                      Leading open source admin dashboard template used by thousands of developers and Fortune 500s.
                      Bootstrap Gallery Admin Panels are built on top of Bootstrap 5.
                    </p>
                    <p class="lh-base">
                    ...
                    <p class="lh-lg">
                      FREE and Premium admin dashboard and admin panel themes. Built on top of Bootstrap 5, provides a
                      range of responsive, reusable, commonly used widgets and UI components.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-12">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <figure class="border-3 border-start border-primary p-3 m-0">
                      <blockquote class="blockquote m-0">
                        <p>Best Admin Dashboard Templates Developed By Bootstrap Gallery</p>
                      </blockquote>
              ...
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Blockquote Centered</h5>
                  </div>
                  <div class="card-body">
                    <figure class="text-center text-center border border-2 border-primary p-3 m-0">
                      <blockquote class="blockquote m-0">
                        <p>Best Admin Dashboard Templates Developed By Bootstrap Gallery</p>
                      </blockquote>
                      <figcaption class="blockquote-footer m-0">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5 class="card-title">Blockquote End</h5>
                  </div>
                  <div class="card-body">
                    <figure class="text-end border-3 border-end border-primary p-3 m-0">
                      <blockquote class="blockquote m-0">
                        <p>Best Admin Dashboard Templates Developed By Bootstrap Gallery</p>
                      </blockquote>
                      <figcaption class="blockquote-footer m-0">
