...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:40 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <!-- Steps Wizard CSS -->
    <link rel="stylesheet" href="assets/vendor/wizard/wizard.css" />
  </head>
  ...
  <body>
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="form-wizard.html" class="active-sub">Form Wizard</a>
                  </li>
                </ul>
              </li>
              <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Wizard</h5>
            <!-- Page title ends -->
          ...
          <div class="app-body">
                      ...
                      <div class="tab-content">
                        <div id="step-1a" class="tab-pane" role="tabpanel" aria-labelledby="step-1a">
                          ...
                          <div class="row gx-4">
                            <div class="col-sm-3 col-12">
                              <div class="mb-3">
                                <label class="form-label" for="aa">Name</label>
                                <input type="text" class="form-control" id="aa" placeholder="Enter Name">
                              </div>
                            </div>
                            <div class="col-sm-3 col-12">
                              <div class="mb-3">
                                <label class="form-label" for="ab">Email</label>
                                <input type="email" class="form-control" id="ab" placeholder="Enter Email">
                              </div>
                            </div>
                            <div class="col-sm-3 col-12">
                              <div class="mb-3">
                                <label class="form-label" for="ac">Contact</label>
                                <input type="number" class="form-control" id="ac" placeholder="Enter Contact">
                              </div>
                            </div>
                            <div class="col-sm-3 col-12">
                              <div class="mb-3">
                                <label class="form-label" for="ad">Coupon</label>
                                <input type="text" class="form-control" id="ad" placeholder="Enter Coupon">
                              </div>
                            </div>
                          </div>
                          <!-- Row ends -->
                        ...
                        <div id="step-1b" class="tab-pane" role="tabpanel" aria-labelledby="step-1b">
                          ...
                          <div class="row gx-4">
                            <div class="col-sm-3 col-12">
                              <div class="mb-3">
                                <label class="form-label" for="ae">Total Amount</label>
                            ...
                            <div class="col-sm-3 col-12">
                              <div class="mb-3">
                                <label class="form-label" for="af">Discount Amount</label>
                                <div class="input-group">
                            ...
                            <div class="col-sm-3 col-12">
                              <div class="mb-3">
                                <label class="form-label" for="ag">Offered Amount</label>
                                <div class="input-group">
                            ...
                            <div class="col-sm-3 col-12">
                              <div class="mb-3">
                                <label class="form-label" for="ah">Final Amount</label>
                                <div class="input-group">
                        ...
                        <div id="step-1c" class="tab-pane" role="tabpanel" aria-labelledby="step-1c">
                          ...
                          <div class="row gx-4">
                            <div class="m-0">
                              <label class="form-label" for="ai">Message</label>
                              <textarea class="form-control" id="ai" rows="3"></textarea>
                            </div>
                          </div>
                          <!-- Row ends -->
                          ...
                          <div class="row align-items-center">
                            <div class="col-12">
                              <div class="form-check m-0">
                                <input class="form-check-input" type="checkbox" id="aj">
                                <label class="form-check-label" for="aj">
                                  Agree Terms & Condtitions.
                                </label>
                              </div>
                            </div>
                          </div>
            ...
            <div class="row gx-4">
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Arrow Step Style</h5>
                  </div>
                  <div class="card-body">
                    ...
                    <div id="smartwizard2">
                      ...
                      <div class="tab-content">
                        <div id="step-2a" class="tab-pane" role="tabpanel" aria-labelledby="step-2a">
                          Download Bootstrap 5+ Admin & Dashboard themes and templates built or reviewed by the
                          creators
                          of Bootstrap. FREE and Premium admin dashboard and admin panel themes. Built on top of
                          Bootstrap 5, provides a range of responsive, reusable, commonly used widgets and UI
                          components.
                        </div>
                        <div id="step-2b" class="tab-pane" role="tabpanel" aria-labelledby="step-2b">
                          Enhance your workflow and elevate your web development process with our range of
                          high-quality
                          Premium Bootstrap admin dashboard templates.
                        </div>
                        <div id="step-2c" class="tab-pane" role="tabpanel" aria-labelledby="step-2c">
                          Leading open source admin dashboard template used by thousands of developers and Fortune
                          500s.
                          Bootstrap Gallery admin panels are built on top of Bootstrap 5. Smart and low-cost bootstrap
                          admin dashboards designed and developed by Bootstrap Gallery.
                        </div>
                        <div id="step-2d" class="tab-pane" role="tabpanel" aria-labelledby="step-2d">
                          A CRM dashboard is a centralized hub for customer relationship management (CRM) data. It
                          presents sales data and information in a visually appealing, dynamic, and interactive
                          manner.
                        </div>
                      </div>
            ...
            <div class="row gx-4">
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Dotted Step Style</h5>
                  </div>
                  <div class="card-body">
                    ...
                    <div id="smartwizard3">
                      ...
                      <div class="tab-content">
                        <div id="step-3a" class="tab-pane" role="tabpanel" aria-labelledby="step-3a">
                          FREE and Premium admin dashboard and admin panel themes. Built on top of Bootstrap 5,
                          provides
                        ...
                        <div id="step-3b" class="tab-pane" role="tabpanel" aria-labelledby="step-3b">
                          Bootstrap Admin Themes and admin templates for your next project. Enhance your workflow and
                          elevate your web development process with our range of high-quality Premium Bootstrap admin
                          dashboard templates.
                        </div>
                        <div id="step-3c" class="tab-pane" role="tabpanel" aria-labelledby="step-3c">
                          Smart and low-cost bootstrap admin dashboards designed and developed by Bootstrap Gallery.
                        </div>
            ...
            <div class="row gx-4">
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5 class="card-title">Dotted Round Style</h5>
                  </div>
                  <div class="card-body">
                    ...
                    <div id="smartwizard4">
                      ...
                      <div class="tab-content">
                        <div id="step-4a" class="tab-pane" role="tabpanel" aria-labelledby="step-4a">
                          Browse Through Tens of Thousands of Responsive Templates & Themes, Starting From $2. Check
                          out
                          the Best Website Themes & Get Yourself Online with Ready-Made Templates. FREE and Premium
                          admin dashboard and admin panel themes. Built on top of Bootstrap 5, provides a range of
                          responsive, reusable, commonly used widgets and UI components.
                        </div>
                        <div id="step-4b" class="tab-pane" role="tabpanel" aria-labelledby="step-4b">
                          Download 100+ fully customizable and responsive Admin Templates and Dashboard UI Kits.
                          Created
                          by professionals and handpicked by Bootstrap Gallery.
                        </div>
                        <div id="step-4c" class="tab-pane" role="tabpanel" aria-labelledby="step-4c">
                          Download the best Admin & Dashboard Templates developed by Bootstrap Gallery. Join over
                          55,000
                          creatives that already love our bootstrap resources! Smart and low-cost bootstrap admin
                          dashboards designed and developed by Bootstrap Gallery.
                        </div>
    ...
    <!-- Steps wizard JS -->
    <script src="assets/vendor/wizard/wizard.min.js"></script>
    <script src="assets/vendor/wizard/wizard-custom.js"></script>
...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:41 GMT -->
</html>