...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/carousel.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:30 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="carousel.html" class="active-sub">Carousel</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Carousel</h5>
            <!-- Page title ends -->
                    ...
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="assets/images/thumbs/img7.jpg" class="d-block w-100" alt="Arise Admin Template">
                        </div>
                        <div class="carousel-item">
                          <img src="assets/images/thumbs/img8.jpg" class="d-block w-100" alt="Arise Admin Template">
                        </div>
                        <div class="carousel-item">
                          <img src="assets/images/thumbs/img9.jpg" class="d-block w-100" alt="Arise Admin Template">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card mb-4">
                  <div class="card-body">
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="assets/images/thumbs/img3.jpg" class="d-block w-100" alt="Axis Admin Template">
                        </div>
                        <div class="carousel-item">
                          <img src="assets/images/thumbs/img7.jpg" class="d-block w-100" alt="Axis Admin Template">
                        </div>
                        <div class="carousel-item">
                          <img src="assets/images/thumbs/img6.jpg" class="d-block w-100" alt="Axis Admin Template">
                        </div>
                      </div>
                ...
                <div class="card mb-4">
                  <div class="card-body">
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="assets/images/thumbs/img4.jpg" class="d-block w-100" alt="Axis Admin Template">
                        </div>
                        <div class="carousel-item">
                          <img src="assets/images/thumbs/img9.jpg" class="d-block w-100" alt="Axis Admin Template">
                        </div>
                        <div class="carousel-item">
                          <img src="assets/images/thumbs/img5.jpg" class="d-block w-100" alt="Axis Admin Template">
                        </div>
                      </div>
                  ...
                  <div class="card-body">
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                          <img src="assets/images/thumbs/img10.jpg" class="d-block w-100" alt="Axis Admin Template">
                          <div class="carousel-caption d-none d-md-block">
                ...
                <div class="card mb-4">
                  <div class="card-body">
                    <div id="carouselExampleFade" class="carousel slide carousel-dark carousel-fade"
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="assets/images/thumbs/img8.jpg" class="d-block w-100" alt="Axis Admin Template">
                        </div>
                        <div class="carousel-item">
                          <img src="assets/images/thumbs/img9.jpg" class="d-block w-100" alt="Axis Admin Template">
                        </div>
                    ...
                    <div id="carouselExampleInterval" class="carousel carousel-dark slide" data-bs-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        ...
                        <div class="carousel-item" data-bs-interval="5000">
                          <img src="assets/images/thumbs/img2.jpg" class="d-block w-100" alt="Axis Admin Template">
                        </div>
