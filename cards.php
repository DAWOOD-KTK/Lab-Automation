...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:30 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="cards.html" class="active-sub">Cards</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Cards</h5>
            <!-- Page title ends -->
          ...
          <div class="app-body">
            ...
            <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4">
              <div class="col">
                <div class="card mb-4">
                  <div class="card-cover rounded-3" style="background-image: url('assets/images/thumbs/img5.jpg');">
              ...
              <div class="col">
                <div class="card mb-4">
                  <div class="card-cover rounded-3" style="background-image: url('assets/images/thumbs/img6.jpg');">
                    <div class="p-5 text-white">
                      <h4 class="display-5 fw-lighter mb-4">
                        Another longer title belongs here
                      </h4>
              ...
              <div class="col">
                <div class="card mb-4">
                  <div class="card-cover rounded-3" style="background-image: url('assets/images/thumbs/img7.jpg');">
                    <div class="p-5 text-white">
                      <h4 class="display-5 fw-lighter mb-4">
                        Another longer title belongs here
                      </h4>
            ...
            <div class="row gx-4">
              <div class="col-sm-4 col-12">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <div class="card-img">
                      <img src="assets/images/thumbs/img8.jpg" class="img-fluid rounded-3 mb-3"
              ...
              <div class="col-sm-4 col-12">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <div class="card-img">
                      <img src="assets/images/thumbs/img9.jpg" class="img-fluid rounded-3 mb-3"
                        alt="Axis Admin Template" />
                    </div>
                    <p class="mb-4">
                      Some quick example text to build on the card title and make up the bulk of the card's content.
              ...
              <div class="col-sm-4 col-12">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <div class="card-img">
                      <img src="assets/images/thumbs/img10.jpg" class="img-fluid rounded-3 mb-3"
                        alt="Axis Admin Template" />
                    </div>
                    <p class="mb-4">
                      Some quick example text to build on the card title and make up the bulk of the card's content.
            ...
            <div class="row gx-4">
              <div class="col-sm-4 col-12">
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="card-img">
                      <img src="assets/images/thumbs/img1.jpg" class="img-fluid rounded-3 mb-3"
                        alt="Axis Admin Template" />
                    </div>
              ...
              <div class="col-sm-4 col-12">
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="card-img">
                      <img src="assets/images/thumbs/img2.jpg" class="img-fluid rounded-3 mb-3"
                        alt="Axis Admin Template" />
                    </div>
                    <h5 class="mb-3">Card Title</h5>
                    <p class="mb-3">
              ...
              <div class="col-sm-4 col-12">
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="card-img">
                      <img src="assets/images/thumbs/img3.jpg" class="img-fluid rounded-3 mb-3"
                        alt="Axis Admin Template" />
                    </div>
                    <h5 class="mb-3">Card Title</h5>
                    <p class="mb-3">
