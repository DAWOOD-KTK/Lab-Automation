...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/tabs.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:32 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="tabs.html" class="active-sub">Tabs</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Tabs</h5>
            <!-- Page title ends -->
          ...
          <div class="app-body">
            ...
            <div class="row gx-4">
              ...
              <div class="col-sm-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Base Nav</h5>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-sm-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Nav Center</h5>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-sm-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Nav Right</h5>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-sm-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Underline</h5>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-sm-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Fill and Justify</h5>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-sm-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Fill and Justify Links</h5>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Nav Justify</h5>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-sm-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Nav Vertical List</h5>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-sm-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Nav Vertical Links</h5>
                  </div>
                  <div class="card-body">
                  ...
                  <div class="card-body">
                    <div class="custom-tabs-container">
                      <ul class="nav nav-tabs" id="customTab3" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                          <a class="nav-link disabled" id="tab-fourAA" data-bs-toggle="tab" href="#fourAA" role="tab"
                      ...
                      <div class="tab-content" id="customTabContent3">
                        <div class="tab-pane fade show active" id="oneAA" role="tabpanel" aria-labelledby="tab-oneAA">
                          <div class="p-3 text-center">
                            ...
                            <div class="col-lg-6 mx-auto">
                              <p class="lead mb-4">
                                Download 100+ fully customizable and responsive Bootstrap Admin Templates and Dashboard
                                UI Kits. Designed and Developed by Bootstrap Gallery.
                              </p>
                        ...
                        <div class="tab-pane fade" id="fourAA" role="tabpanel" aria-labelledby="tab-fourAA">
                          <h5 class="text-info">Tab Four Description</h5>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Custom Tab Badges</h5>
                  </div>
                  <div class="card-body">
                    <div class="custom-tabs-container">
                      ...
                      <div class="tab-content" id="customTabContent2">
                        <div class="tab-pane fade show active" id="oneA" role="tabpanel">
                          <div class="row gx-4">
                            <div class="col">
                              <img src="assets/images/thumbs/img9.jpg" background-size: cover; class="img-fluid mb-2"
                                alt="Bootstrap Gallery" />
                            </div>
                            <div class="col">
                              <img src="assets/images/thumbs/img8.jpg" background-size: cover; class="img-fluid mb-2"
                                alt="Bootstrap Gallery" />
                            </div>
                            <div class="col">
                              <img src="assets/images/thumbs/img7.jpg" background-size: cover; class="img-fluid mb-2"
                                alt="Bootstrap Gallery" />
                            </div>
                            <div class="col">
                              <img src="assets/images/thumbs/img6.jpg" background-size: cover; class="img-fluid mb-2"
                                alt="Bootstrap Gallery" />
                            </div>
                            <div class="col">
                              <img src="assets/images/thumbs/img5.jpg" background-size: cover; class="img-fluid mb-2"
                                alt="Bootstrap Gallery" />
                            </div>
                            <div class="col">
                              <img src="assets/images/thumbs/img4.jpg" background-size: cover; class="img-fluid mb-2"
                                alt="Bootstrap Gallery" />
                            </div>
                            <div class="col">
                              <img src="assets/images/thumbs/img3.jpg" background-size: cover; class="img-fluid mb-2"
                                alt="Bootstrap Gallery" />
                            </div>
                            <div class="col">
                              <img src="assets/images/thumbs/img2.jpg" background-size: cover; class="img-fluid mb-2"
                                alt="Bootstrap Gallery" />
                            </div>
                            <div class="col">
                              <img src="assets/images/thumbs/img1.jpg" background-size: cover; class="img-fluid mb-2"
                                alt="Bootstrap Gallery" />
                            </div>
                          </div>
                        </div>
              ...
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Custom Tabs with Icons</h5>
                  </div>
                  <div class="card-body">
                    <div class="custom-tabs-container">
                      <ul class="nav nav-tabs" id="customTab3" role="tablist">
                        <li class="nav-item" role="presentation">
                          <a class="nav-link active" id="tab-oneAA" data-bs-toggle="tab" href="#oneAA" role="tab"
                            aria-controls="oneAA" aria-selected="true"><i class="bi bi-hand-thumbs-up me-2"></i>Tab
                            One</a>
                        </li>
                        <li class="nav-item" role="presentation">
                          <a class="nav-link" id="tab-twoAA" data-bs-toggle="tab" href="#twoAA" role="tab"
                            aria-controls="twoAA" aria-selected="false"><i class="bi bi-emoji-smile me-2"></i>Tab
                            Two</a>
                        </li>
                        <li class="nav-item" role="presentation">
                          <a class="nav-link" id="tab-threeAA" data-bs-toggle="tab" href="#threeAA" role="tab"
                            aria-controls="threeAA" aria-selected="false"><i class="bi bi-shield-check me-2"></i>Tab
                            Three</a>
                        </li>
                      </ul>
                      <div class="tab-content" id="customTabContent3">
              ...
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Center Aligned Tabs</h5>
                  </div>
                  <div class="card-body">
                    <div class="custom-tabs-container">
                      ...
                      <div class="tab-content" id="customTabContent">
                        <div class="tab-pane fade show active" id="oneAAA" role="tabpanel">
                          ...
                          <div class="row gx-4">
                            <div class="col-sm-4 col-12">
                              <div class="card border-0 card-cover rounded-4"
                                style="background-image: url('assets/images/thumbs/img1.jpg');background-size: cover;">
                            ...
                            <div class="col-sm-4 col-12">
                              <div class="card border-0 card-cover rounded-4"
                                style="background-image: url('assets/images/thumbs/img5.jpg');background-size: cover;">
                                <div class="backdrop-blur rounded-4">
                                  <div class="p-5 text-white">
                                    <h2 class="display-6 text-center">
                                      Another longer title belongs here
                            ...
                            <div class="col-sm-4 col-12">
                              <div class="card border-0 card-cover rounded-4"
                                style="background-image: url('assets/images/thumbs/img9.jpg');background-size: cover;">
                                <div class="backdrop-blur rounded-4">
                                  <div class="p-5 text-white">
                                    <h2 class="display-6 text-center">
                                      Another longer title belongs here
                        ...
                        <div class="tab-pane fade" id="twoAAA" role="tabpanel">
                          ...
                          <div class="row gx-4">
                            <div class="col-sm-4 col-12">
                              <div class="card border-0 card-cover rounded-5"
                                style="background-image: url('assets/images/thumbs/img4.jpg');background-size: cover;">
                            ...
                            <div class="col-sm-4 col-12">
                              <div class="card border-0 card-cover rounded-5"
                                style="background-image: url('assets/images/thumbs/img8.jpg'); background-size: cover;">
                                <div class="backdrop-blur rounded-5">
                                  <div class="p-5 text-white">
                                    <h2 class="display-6 text-center">
                                      Another longer title belongs here
                            ...
                            <div class="col-sm-4 col-12">
                              <div class="card border-0 card-cover rounded-5"
                                style="background-image: url('assets/images/thumbs/img3.jpg');background-size: cover;">
                                <div class="backdrop-blur rounded-5">
                                  <div class="p-5 text-white">
                                    <h2 class="display-6 text-center">
                                      Another longer title belongs here
                        ...
                        <div class="tab-pane fade" id="threeAAA" role="tabpanel">
                          ...
                          <div class="row gx-4">
                            <div class="col-sm-4 col-12">
                              <div class="card border-0 card-cover"
                                style=" background-image: url('assets/images/thumbs/img2.jpg'); background-size: cover;">
                            ...
                            <div class="col-sm-4 col-12">
                              <div class="card border-0 card-cover"
                                style="background-image: url('assets/images/thumbs/img10.jpg'); background-size: cover;">
                                <div class="backdrop-blur">
                                  <div class="p-5 text-white">
                                    <h2 class="display-6 text-center">
                                      Another longer title belongs here
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5 class="card-title">Right Aligned Tabs</h5>
                  </div>
                  <div class="card-body">
                    <div class="custom-tabs-container">
