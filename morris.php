...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/morris.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:47 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="morris.html" class="active-sub">Morris</a>
                  </li>
                </ul>
              </li>
              <li class="treeview">
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Morris</h5>
            <!-- Page title ends -->
            ...
            <div class="row gx-4">
              ...
              <div class="col-xl-6">
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    <div id="morrisBar" class="chart-height"></div>
                  </div>
                </div>
              </div>
              <div class="col-xl-6">
              ...
              <div class="col-xl-6">
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    <div id="stackedBar" class="chart-height"></div>
                  </div>
                </div>
              </div>
            </div>
...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/morris.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:50 GMT -->
</html>