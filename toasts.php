...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/toasts.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:32 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="toasts.html" class="active-sub">Toasts</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Toasts</h5>
            <!-- Page title ends -->
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <div class="text-center">
                      ...
                      <div class="toast-container position-fixed top-0 end-0 p-3">
                        <div id="topRightToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                          <div class="toast-header">
                            ...
                            <strong class="me-auto">Bootstrap Gallery</strong>
                            <small>3 mins ago</small>
                            <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
                          </div>
                          <div class="toast-body">
                            Hello, world! This is a Bootstrap Gallery.
                          </div>
                        </div>
                      </div>

                      <!-- Toast Top Left Button -->
                      <button type="button" class="btn btn-primary" id="topLeftBtn">Top Left</button>

                      <!-- Toast Message - Added JS in Custom Toast.JS file -->
                      <div class="toast-container position-fixed top-0 start-0 p-3">
                        <div id="topLeftToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                          <div class="toast-header">
                            <i class="bi bi-hand-thumbs-up-fill text-primary me-2 fs-2"></i>
                            <strong class="me-auto">Bootstrap Gallery</strong>
                            <small>3 mins ago</small>
                      ...
                      <button type="button" class="btn btn-primary" id="bottomLeftBtn">Bottom Left</button>

                      <!-- Toast Message - Added JS in Custom Toast.JS file -->
                      <div class="toast-container position-fixed bottom-0 start-0 p-3">
                        <div id="bottomLeftToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                          <div class="toast-header">
                            <i class="bi bi-hand-thumbs-up-fill text-primary me-2 fs-2"></i>
                            <strong class="me-auto">Bootstrap Gallery</strong>
                            <small>3 mins ago</small>
                      ...
                      <button type="button" class="btn btn-primary" id="bottomRightBtn">Bottom Right</button>

                      <!-- Toast Message - Added JS in Custom Toast.JS file -->
                      <div class="toast-container position-fixed bottom-0 end-0 p-3">
                        <div id="bottomRightToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                          <div class="toast-header">
                            <i class="bi bi-hand-thumbs-up-fill text-primary me-2 fs-2"></i>
                            <strong class="me-auto">Bootstrap Gallery</strong>
                            <small>3 mins ago</small>
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <div class="text-center">
                      ...
                      <!-- Toast Info Button -->
                      <button type="button" class="btn btn-info" id="toastInfoBtn">Info</button>

                      <!-- Toast Message - Added JS in Custom Toast.JS file -->
                      <div class="toast-container position-fixed top-0 end-0 p-3">
                        <div id="toastInfo" class="toast text-bg-info" role="alert" aria-live="assertive"
                          aria-atomic="true">
                      ...
                      <button type="button" class="btn btn-success" id="toastSuccessBtn">Success</button>

                      <!-- Toast Message - Added JS in Custom Toast.JS file -->
                      <div class="toast-container position-fixed top-0 end-0 p-3">
                        <div id="toastSuccess" class="toast text-bg-success" role="alert" aria-live="assertive"
                          aria-atomic="true">
                      ...
                      <button type="button" class="btn btn-warning" id="toastWarningBtn">Warning</button>

                      <!-- Toast Message - Added JS in Custom Toast.JS file -->
                      <div class="toast-container position-fixed top-0 end-0 p-3">
                        <div id="toastWarning" class="toast text-bg-warning" role="alert" aria-live="assertive"
                          aria-atomic="true">
              ...
              <div class="col-12">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <!-- Toast container for stacking starts -->
                    ...
                    <!-- Toast container for stacking dnds -->
