...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/tooltips.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:32 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="tooltips.html" class="active-sub">Tooltips</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Tooltips</h5>
            <!-- Page title ends -->
              ...
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-body text-center">
                    ...
                    <button type="button" class="btn btn-dark" data-bs-toggle="tooltip" data-bs-html="true"
              ...
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-body text-center">
                    ...
                    <button type="button" class="btn btn-outline-dark" data-bs-toggle="tooltip" data-bs-html="true"
                      data-bs-title="<em>Tooltip</em> <u>with</u> <b>HTML</b>">
                      Tooltip with HTML
                    </button>
                  </div>
                ...
                <div class="card mb-4">
                  <div class="card-body text-center">
                    <button type="button" class="btn btn-outline-danger" data-bs-toggle="tooltip"
                      data-bs-placement="left" data-bs-custom-class="custom-tooltip-danger"
                      data-bs-title="This top tooltip is themed via CSS variables.">
                      Custom tooltip danger
                    </button>
                    <button type="button" class="btn btn-outline-info" data-bs-toggle="tooltip"
                      data-bs-placement="bottom" data-bs-custom-class="custom-tooltip-info"
                      data-bs-title="This top tooltip is themed via CSS variables.">
                      Custom tooltip info
                    </button>
                    ...
                    <button type="button" class="btn btn-outline-warning" data-bs-toggle="tooltip"
                      data-bs-placement="right" data-bs-custom-class="custom-tooltip-warning"
                      data-bs-title="This top tooltip is themed via CSS variables.">
                      Custom tooltip warning
                    </button>
                  </div>
