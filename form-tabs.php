...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/form-tabs.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:40 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="form-tabs.html" class="active-sub">Form Tabs</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Form Tabs</h5>
            <!-- Page title ends -->
                        ...
                        <li class="nav-item" role="presentation">
                          <a class="nav-link" id="tab-threeAA" data-bs-toggle="tab" href="#threeAA" role="tab"
                            aria-controls="threeAA" aria-selected="false" tabindex="-1"><i
                              class="bi bi-journal-bookmark me-2"></i>Communication</a>
                        </li>
                      </ul>
                          ...
                          <div class="row gx-4">
                            <div class="col-xl-3 col-sm-4 col-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" autocomplete="autocomplete" id="name"
                            ...
                            <div class="col-xl-3 col-sm-4 col-12">
                              <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" autocomplete="autocomplete"
                            ...
                            <div class="col-xl-3 col-sm-4 col-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="company" autocomplete="autocomplete"
                            ...
                            <div class="col-xl-3 col-sm-4 col-12">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="terri"
                          ...
                          <div class="row gx-4">
                            ...
                            <div class="col-12">
                              <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" id="msg2" placeholder="Enter message"
                                  rows="3"></textarea>
                              </div>
                            </div>
                            <div class="col-sm-12 col-12">
