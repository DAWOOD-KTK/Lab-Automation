...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:31 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="modals.html" class="active-sub">Modals</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Modals</h5>
            <!-- Page title ends -->
          ...
          <div class="app-body">
                      ...
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          <div class="modal-body p-5 text-center">
                            ...
                            <h4 class="text-success">Payment Successful</h4>
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eius aliquam laudantium
                              explicabo pariatur iste dolorem animi vitae error totam. At sapiente aliquam accusamus
                              facere veritatis.</p>
                            <div class="d-flex gap-2">
                              <button type="button" class="btn btn-lg btn-outline-dark w-100" data-bs-dismiss="modal">
                                Cancel
                              </button>
                              <button type="button" class="btn btn-lg btn-dark w-100" data-bs-dismiss="modal">
                                Deactivate
                              </button>
                            </div>
                          </div>
                          ...
                          <div class="modal-body p-5">
                            ...
                            <ul class="d-grid gap-4 my-5 list-unstyled">
                              <li class="d-flex align-items-center gap-3">
                                <div class="border border-primary p-3 rounded-5">
                                  <i class=" bi bi-check-circle fs-1 lh-1 text-primary"></i>
                                </div>
                                <div>
                                  <h5>Grid view</h5>
                            ...
                            <button type="button" class="btn btn-lg btn-primary mt-3 w-100" data-bs-dismiss="modal">
                              Great, thanks!
                            </button>
                          </div>
                        </div>
            ...
            <div class="row gx-4">
              <div class="col-sm-12">
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="modal position-static d-block shade-light rounded-3" tabindex="-1" role="dialog" id="2">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer flex-column">
                            ...
                            <button type="button" class="btn btn-lg btn-dark w-100 mx-0" data-bs-dismiss="modal">
                              Close
                            </button>
                          </div>
                        </div>
