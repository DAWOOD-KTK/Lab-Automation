...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/list-items.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:31 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="list-items.html" class="active-sub">List Items</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">List Items</h5>
            <!-- Page title ends -->
                  ...
                  <div class="card-body">
                    <div class="list-group">
                      <div class="list-group-item d-flex gap-3 py-3" aria-current="true">
                        <img src="assets/images/thumbs/img4.jpg" alt="Bootstrap Gallery" class="rounded-2 w-25">
                        <div class="d-flex gap-2 w-100 justify-content-between align-items-start">
                          <div>
                            ...
                            <p class="text-dark">
                              ...
                              provides a range of responsive, reusable, commonly used widgets and UI components.
                            </p>
                          ...
                          <small class="badge border border-primary text-primary">50% OFF</small>
                        </div>
                      </div>
                      <div class="list-group-item d-flex gap-3 py-3" aria-current="true">
                        <img src="assets/images/thumbs/img8.jpg" alt="Bootstrap Gallery" class="rounded-2 w-25">
                        <div class="d-flex gap-2 w-100 justify-content-between align-items-start">
                          <div>
                            <h4>Product Name</h4>
                            <p class="text-dark">
                          ...
                          <small class="badge border border-primary text-primary">75% OFF</small>
                        </div>
                      </div>
                      <div class="list-group-item d-flex gap-3 py-3" aria-current="true">
                        <img src="assets/images/thumbs/img6.jpg" alt="Bootstrap Gallery" class="rounded-2 w-25">
                        <div class="d-flex gap-2 w-100 justify-content-between align-items-start">
                          <div>
                            <h4>Product Name</h4>
                            <p class="text-dark">
                          ...
                          <small class="badge bg-primary">90% OFF</small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    <ul class="d-grid gap-4 list-unstyled">
                      <li class="d-flex align-items-center gap-3">
                        <i class="border border-primary p-3 rounded-3 bi bi-receipt fs-1 text-primary lh-1"></i>
                        <div>
                          <h5>Grid view</h5>
                  ...
                  <div class="card-body">
                    <div class="list-group w-auto">
                      <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
                        <img src="assets/images/thumbs/img1.jpg" alt="Bootstrap Gallery"
              ...
              <div class="col-sm-6">
                ...
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="list-group w-auto">
                      <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
                        <img src="assets/images/thumbs/img4.jpg" alt="Bootstrap Gallery"
                          class="rounded-circle flex-shrink-0 img-3x" />
                        <div class="d-flex gap-2 w-100 justify-content-between align-items-start">
                          <div>
                            <h6 class="mb-0">List group item heading</h6>
                          ...
                          <small class="badge border border-primary text-primary">Now</small>
                        </div>
                      </a>
                      <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
                        <img src="assets/images/thumbs/img5.jpg" alt="Bootstrap Gallery"
                          class="rounded-circle flex-shrink-0 img-3x" />
                        <div class="d-flex gap-2 w-100 justify-content-between align-items-start">
                          <div>
                            <h6 class="mb-0">Another title here</h6>
                          ...
                          <small class="badge border border-primary text-primary">3 Days</small>
                        </div>
                      </a>
                      <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
                        ...
                        <div class="d-flex gap-2 w-100 justify-content-between align-items-start">
                          ...
                          <small class="badge border border-primary text-primary">1 Week</small>
                        </div>
                      </a>
                    </div>
                  </div>
