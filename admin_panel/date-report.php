...
// Build main query
$sql = "SELECT * FROM testing_data WHERE 1=1";
...
$sql .= " ORDER BY created_at DESC"; // use correct column
...
$total_count     = mysqli_fetch_assoc(mysqli_query($conn,"SELECT COUNT(*) as total FROM testing_data WHERE 1 $date_filter"))['total'];
$pending_count   = mysqli_fetch_assoc(mysqli_query($conn,"SELECT COUNT(*) as total FROM testing_data WHERE send_to='Pending' $date_filter"))['total'];
$completed_count = mysqli_fetch_assoc(mysqli_query($conn,"SELECT COUNT(*) as total FROM testing_data WHERE send_to='CPRI' $date_filter"))['total'];

?>

<div class="app-body">
    <h1 class="title text-center my-4 p-2" style="background:#6f42c1; color:white; border-radius:10px;">Date-wise Testing Report</h1>
