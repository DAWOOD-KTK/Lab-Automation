...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/progress.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:31 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="progress.html" class="active-sub">Progress Bars</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Progress</h5>
            <!-- Page title ends -->
                  ...
                  <div class="card-body">
                    <div class="d-flex">
                      <div class="progress progress-vertical thin">
                        <div class="progress-bar bg-secondary" role="progressbar" style="height: 10%" aria-valuenow="10"
                          aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                      <div class="m-3"></div>
