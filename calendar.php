...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/calendar.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:41 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Calendar</h5>
            <!-- Page title ends -->
                  ...
                  <div class="card-body">
                    <div class="d-flex mb-2">
                      ...
                      <div class="d-flex flex-column">
                        <h2 class="m-0 lh-1">28</h2>
                        <p class="m-0 opacity-50">Holidays</p>
                      </div>
                    </div>
                    <div class="m-0">
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="d-flex mb-2">
                      ...
                      <div class="d-flex flex-column">
                        <h2 class="m-0 lh-1">24</h2>
                        <p class="m-0 opacity-50">Leaves</p>
                      </div>
                    </div>
                    <div class="m-0">
                      <div class="progress thin mb-2">
                  ...
                  <div class="card-body">
                    <div class="d-flex mb-2">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <p class="m-0 opacity-50">Meetings</p>
                      </div>
                    </div>
                    <div class="m-0">
                      <div class="progress thin mb-2">
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="d-flex mb-2">
                      ...
                      <div class="d-flex flex-column">
                        <h2 class="m-0 lh-1">05</h2>
                        <p class="m-0 opacity-50">Interviews</p>
                      </div>
                    </div>
                    <div class="m-0">
                      <div class="progress thin mb-2">
...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/calendar.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:42 GMT -->
</php>