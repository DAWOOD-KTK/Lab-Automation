...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/dropdowns.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:30 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="dropdowns.html" class="active-sub">Dropdowns</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Dropdowns</h5>
            <!-- Page title ends -->
              ...
              <div class="col-sm-12">
                ...
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Dropdown Button</h5>
                  </div>
                  <div class="card-body">
