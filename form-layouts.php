...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/form-layouts.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:40 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="form-layouts.html" class="active-sub">Form Layouts</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Form Layouts</h5>
            <!-- Page title ends -->
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row gx-4">
                      ...
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a3">Phone</label>
                          <input type="number" class="form-control" id="a3" placeholder="Enter phone number">
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a4">Company</label>
                          <input type="text" class="form-control" id="a4" placeholder="Enter company name">
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a5">Business Address</label>
                          <input type="text" class="form-control" id="a5" placeholder="Enter business address">
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a6">Province/Territory</label>
                          <input type="text" class="form-control" id="a6" placeholder="Enter province/territory">
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a7">Industry Type</label>
                      ...
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a8">Postal Code</label>
                          <input type="number" class="form-control" id="a8" placeholder="Enter postal code">
                        </div>
                      </div>
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row gx-4">
                      ...
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a10">Name</label>
                          <input type="text" class="form-control" id="a10" placeholder="Enter fullname">
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a11">Email</label>
                          <input type="email" class="form-control" id="a11" placeholder="Enter email address">
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a12">Phone</label>
                          <input type="number" class="form-control" id="a12" placeholder="Enter phone number">
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a13">Company</label>
                          <input type="text" class="form-control" id="a13" placeholder="Enter company name">
                        </div>
                      </div>
                    </div>
                    <!-- Row ends -->
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row gx-4">
                      ...
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a14">Business Address</label>
                          <input type="text" class="form-control" id="a14" placeholder="Enter business address">
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a15">Province/Territory</label>
                          <input type="text" class="form-control" id="a15" placeholder="Enter province/territory">
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a16">Industry Type</label>
                      ...
                      <div class="col-lg-3 col-sm-4 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a17">Postal Code</label>
                          <input type="number" class="form-control" id="a17" placeholder="Enter postal code">
                        </div>
                      </div>
                    </div>
                    <!-- Row ends -->
                  ...
                  <div class="card-body">
                    ...
                    <div class="row gx-4">
                      <div class="col-lg-4 col-sm-6 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="a18">Amount</label>
                          <div class="input-group">
                            <input type="text" class="form-control" id="a18">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row gx-4">
                      <div class="col-lg-4 col-sm-6 col-12">
                        <div class="mb-3">
                          <label class="form-label" for="inlineCheckbox1">Communication</label>
                          <div>
                            <div class="form-check form-check-inline">
