...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/placeholders.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:31 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="placeholders.html" class="active-sub">Placeholders</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Placeholders</h5>
            <!-- Page title ends -->
          ...
          <div class="app-body">
            ...
            <div class="row gx-3">
              <div class="col-sm-4">
                <div class="card mb-3">
                  <img src="assets/images/thumbs/img2.jpg" class="card-img-top" alt="Bootstrap Gallery" />
                  <div class="card-body">
                    <h5>Header</h5>
                    <p>
