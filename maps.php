...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/maps.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:50 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <!-- NO UI Slider CSS -->
    <link rel="stylesheet" href="assets/vendor/nouislider/css/nouislider.css" />
  </head>
  ...
  <body>
      ...
      <div class="main-container">
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Maps</h5>
            <!-- Page title ends -->
          ...
          <div class="app-body">
            ...
            <div class="row gx-4">
                    ...
                    <div class="d-flex flex-wrap gap-3 mb-5">
                      <div class="position-relative">
                        <div class="d-flex align-items-center mb-2">
                          <img src="assets/images/flags/1x1/us.svg" class="img-4x rounded-circle" alt="United States">
                          <div class="ms-3">
              ...
              <div class="col-12">
                <div class="card mb-3">
                  <div class="card-header">
                    <h5 class="card-title">Plotted Cities</h5>
                  </div>
                  <div class="card-body">
                    <div class="map-body-xxl">
                      <div class="card-loader">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h5 class="card-title">Range Areas</h5>
                  </div>
                  <div class="card-body">
                    <div class="map-body-xxl">
                      <div class="card-loader">
    ...
    <!-- No UI Slider JS -->
    <script src="assets/vendor/nouislider/js/nouislider.js"></script>

    <!-- Mapael JS -->
    <script src="assets/js/raphael.min.js"></script>
    <script src="assets/vendor/mapael/jquery.mapael.min.js"></script>
    <script src="assets/vendor/mapael/maps/france_departments.min.js"></script>
    <script src="assets/vendor/mapael/maps/world_countries.min.js"></script>
    <script src="assets/vendor/mapael/maps/usa_states.min.js"></script>
    <script src="assets/vendor/mapael/custom/population.js"></script>
    <script src="assets/vendor/mapael/custom/plotted-cities.js"></script>
    <script src="assets/vendor/mapael/custom/range-areas.js"></script>
...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/maps.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:53 GMT -->
</html>