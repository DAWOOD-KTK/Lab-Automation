...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/create-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:50 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
          ...
          <div class="sidebarMenuScroll">
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  <li>
                    <a href="create-invoice.html" class="active-sub">Create Invoice</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Create Invoice</h5>
            <!-- Page title ends -->
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-xxl-4 col-sm-6 col-12">
                        ...
                        <div class="row gx-4">
                          <div class="col-12">
                            <h5 class="fw-semibold mb-3">Billing Detaiils</h5>
                          </div>
                          <div class="col-12">
                            <!-- Form group start -->
                            <div class="mb-3">
                          ...
                          <div class="col-sm-6 col-12">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="date" id="dateIssued" class="form-control" placeholder=" DD/MM/YYYY">
                            </div>
                            <!-- Form group end -->
                          </div>
                          <div class="col-sm-6 col-12">
                          ...
                          <div class="col-12">
                            <!-- Form group start -->
                            <div class="m-0">
                              <label for="msgCustomer" class="form-label">Message to Customer</label>
                    ...
                    <div class="row">
                            ...
                            <table class="table truncate">
                              ...
                              <tbody>
                                <tr>
                                  <td>
                                    <!-- Form group start -->
                                    <select class="form-select" id="selectProduct1">
                                  ...
                                  <td>
                                    <!-- Form group start -->
                                    <div class="m-0">
                                      <input type="number" class="form-control" id="qty1" placeholder="Qty">
                                    </div>
                                    <!-- Form group end -->
                                  </td>
                                  <td>
                                  ...
                                  <td>
                                    <!-- Form group start -->
                                    <div class="input-group m-0">
                                      <input type="text" class="form-control" id="vat1">
                                ...
                                <tr>
                                  <td>
                                    <!-- Form group start -->
                                    <select class="form-select" id="selectProduct2">
                                      <option>Select Product</option>
                                      <option>Mobiles</option>
                                      <option>Books</option>
                                      <option>Clothing</option>
                                  ...
                                  <td>
                                    <!-- Form group start -->
                                    <div class="m-0">
                                      <input type="number" class="form-control" id="qty2" placeholder="Qty">
                                    </div>
                                    <!-- Form group end -->
                                  </td>
                                  <td>
                                ...
                                <tr>
                                  ...
                                  <td colspan="6">
                                    <div class="row justify-content-end">
                                      <div class="col-auto">
                                        <label class="col-form-label" for="disc1">Discount % of Total Amount</label>
                                      </div>
                                      <div class="col-auto">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <p class="m-0">VAT</p>
                                    <h5 class="mt-2 text-danger">Total in USD</h5>
                                  </td>
                                  <td>
                                    <p class="m-0">$0.00</p>
                                    <p class="m-0">$0.00</p>
                                    <p class="m-0">$0.00</p>
                                    <h5 class="mt-2 text-success">$0.00</h5>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                      ...
                      <div class="col-12">
                        <div class="d-flex justify-content-end gap-1">
                          ...
                          <a href="invoice-list.html" class="btn btn-success">Send Invoice</a>
                        </div>
                      </div>
                    </div>
                    <!-- Row ends -->
