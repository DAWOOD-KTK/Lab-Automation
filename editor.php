...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/editor.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:38 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="editor.html" class="active-sub">Editor</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Editor</h5>
            <!-- Page title ends -->
            ...
            <div class="row gx-4">
              <div class="col-12">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <div id="simpleEditor">
                      <h1>Best Admin Dashboards</h1>
                      <br />
                      <p>Welcome to <strong>Bootstrap Gallery</strong></p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Full Editor</h5>
                  </div>
                  <div class="card-body">
                    <div id="fullEditor">
                      <h1>Quality Admin Dashboards</h1>
                      <br />
                      <p>Welcome to <strong>Bootstrap Gallery</strong></p>
                    </div>
                  </div>
...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/editor.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:40 GMT -->
</html>