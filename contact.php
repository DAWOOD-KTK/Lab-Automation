...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:54 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Contact Us</h5>
            <!-- Page title ends -->
                  ...
                  <div class="card-body">
                    ...
                    <div class="row justify-content-center align-items-end">
                      ...
                      <div class="col-xl-8 col-sm-6">
                        <div class="p-3">
                          <h3 class="mb-3">
                            Say Hello <span class="display-5">👋</span>
                          </h3>
                          ...
                          <div class="row gx-4">
                            ...
                            <div class="col-sm-12">
                              <div class="mb-3">
                                ...
                                <textarea rows="3" class="form-control" id="yourMessage"
