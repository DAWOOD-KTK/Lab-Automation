...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/invoice-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:50 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="invoice-list.html" class="active-sub">Invoice List</a>
                  </li>
                </ul>
              </li>
              <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Invoice List</h5>
            <!-- Page title ends -->
          ...
          <div class="app-body">
            ...
            <div class="row gx-4">
              <div class="col-xl-3 col-sm-6 col-12">
                <div class="card mb-3">
                  <div class="card-body">
                    <h6 class="mb-3">Total Invoices</h6>
                    <h2 class="mb-2 d-flex align-items-center justify-content-between">
                      ...
                      <span class="text-primary">$8900</span>
                    </h2>
                    <p class="m-0 small">
                      This month 80% <span class="text-primary"><i class="bi bi-arrow-up-circle-fill"></i></span>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 col-12">
                <div class="card mb-3">
                  <div class="card-body">
                    <h6 class="mb-3">Paid Invoices</h6>
                    <h2 class="mb-2 d-flex align-items-center justify-content-between">
                      <i class="bi bi-journal-check fs-3 lh-1 bg-primary p-3 rounded-3 text-white"></i>
                      <span class="text-primary">$6000</span>
                    </h2>
                    <p class="m-0 small">
                      This month 60% <span class="text-primary"><i class="bi bi-arrow-up-circle-fill"></i></span>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 col-12">
                <div class="card mb-3">
                  <div class="card-body">
                    <h6 class="mb-3">Pending Invoices</h6>
                    <h2 class="mb-2 d-flex align-items-center justify-content-between">
                      <i class="bi bi-journal-plus fs-3 lh-1 bg-primary p-3 rounded-3 text-white"></i>
                      <span class="text-primary">$3000</span>
                    </h2>
                    <p class="m-0 small">
                      This month 30% <span class="text-primary"><i class="bi bi-arrow-up-circle-fill"></i></span>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 col-12">
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <h2 class="mb-2 d-flex align-items-center justify-content-between">
                      <i class="bi bi-journal-x fs-3 lh-1 bg-primary p-3 rounded-3 text-white"></i>
                      <span class="text-primary">$2000</span>
                    </h2>
                    <p class="m-0 small">
                      This month 20% <span class="text-primary"><i class="bi bi-arrow-down-circle-fill"></i></span>
                    </p>
                  </div>
                </div>
              </div>
                        ...
                        <table class="table truncate align-middle">
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <img src="assets/images/user1.png" class="img-3x rounded-5 me-3" alt="Avatar">
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <img src="assets/images/user2.png" class="img-3x rounded-5 me-3" alt="Avatar">
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <img src="assets/images/user3.png" class="img-3x rounded-5 me-3" alt="Avatar">
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <img src="assets/images/user4.png" class="img-3x rounded-5 me-3" alt="Avatar">
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <img src="assets/images/user5.png" class="img-3x rounded-5 me-3" alt="Avatar">
