...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/help.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:54 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Help</h5>
            <!-- Page title ends -->
          ...
          <div class="app-body">
            ...
            <!-- Row starts -->
            <div class="row gx-3 card-group">
              <div class="col-xl-4 col-sm-6">
                <div class="card mb-3">
                  <div class="p-4">
                    <h3 class="display-6 fw-lighter text-primary">
                      Responsive Admin Dashboard Website Templates.
                    </h3>
                    <p class="m-0">
                      A visual way to build the web. Build custom websites, portfolios, ecommerce stores, and more with
                      a flexible CMS. Code visually. Design & develop visually. 24/7 Support.
                    </p>
                    <a href="javascript:void(0)" class="text-primary fs-3 mt-3 d-inline-flex">
                ...
                <div class="card mb-3">
                  <div class="p-4">
                    ...
                    <p class="m-0">
                      Bootstrap Admin Themes and admin templates for your next project. The Bootstrap Admin templates
                      are relatively easy to customize mobile-first that includes ready-made design patterns and comes
                      packaged with a huge library of components and widgets.
                    </p>
                    <a href="javascript:void(0)" class="text-primary fs-3 mt-3 d-inline-flex">
                      <i class="bi bi-arrow-right-circle"></i>
                    </a>
                ...
                <div class="card mb-3">
                  <div class="p-4">
                    <h3 class="display-6 fw-lighter text-primary">
                      Top React Admin Templates.
                    </h3>
                    <p class="m-0">
                      Refine CRM admin is a open source React admin template powered by Bootstrap Gallery.
                    </p>
                    <a href="javascript:void(0)" class="text-primary fs-3 mt-3 d-inline-flex">
                      <i class="bi bi-arrow-right-circle"></i>
                    </a>
                ...
                <div class="card mb-3">
                  <div class="p-4">
                    <h3 class="display-6 fw-lighter text-primary">
                      Best CRM Dashboard Examples.
                    </h3>
                    <p class="m-0">
                      See here the best CRM dashboard examples & report formats created with modern customer
              ...
              <div class="col-xl-4 col-sm-6">
                <div class="card mb-3">
                  <div class="p-4">
                    ...
                    <p class="m-0">
                      Admini is a complete jQuery and Bootstrap 5 admin panel with 100s components, different demos and
                      many color skins.
                    </p>
                    <a href="javascript:void(0)" class="text-primary fs-3 mt-3 d-inline-flex">
                      <i class="bi bi-arrow-right-circle"></i>
                ...
                <div class="card mb-3">
                  <div class="p-4">
                    <h3 class="display-6 fw-lighter text-primary">
                      Admin Website Templates & Examples.
                    </h3>
                    <p class="m-0">
                      visual way to build the web. Build custom websites, portfolios, ecommerce stores, and more with a
                      flexible CMS.
                    </p>
                    <a href="javascript:void(0)" class="text-primary fs-3 mt-3 d-inline-flex">
                      <i class="bi bi-arrow-right-circle"></i>
                ...
                <div class="card mb-3">
                  <div class="p-4">
                    <h3 class="display-6 fw-lighter text-primary">
                      Online Dashboard Template.
                    </h3>
                    <p class="m-0">
                      A CRM dashboard is a customizable tool in many CRM software platforms that gives a high-level
                      overview of a business's sales activity and KPIs.
                    </p>
                    <a href="javascript:void(0)" class="text-primary fs-3 mt-3 d-inline-flex">
                      <i class="bi bi-arrow-right-circle"></i>
                    </a>
                ...
                <div class="card mb-3">
                  <div class="p-4">
                    ...
                    <p class="m-0">
                      CRM dashboards provide a centralized view of your business's data, sales, and key performance
                      indicators.
                    </p>
                    <a href="javascript:void(0)" class="text-primary fs-3 mt-3 d-inline-flex">
                      <i class="bi bi-arrow-right-circle"></i>
              ...
              <div class="col-xl-4 col-sm-6">
                <div class="card mb-3">
                  <div class="p-4">
                    ...
                    <p class="m-0">
                      Leading open source admin dashboard template used by thousands of developers and Fortune 500s.
                      Admini admin panel is built on top of Bootstrap 5.
                    </p>
                    <a href="javascript:void(0)" class="text-primary fs-3 mt-3 d-inline-flex">
                      <i class="bi bi-arrow-right-circle"></i>
                    </a>
                ...
                <div class="card mb-3">
                  <div class="p-4">
                    <h3 class="display-6 fw-lighter text-primary">
                      Admin Templates and Dashboards.
                    </h3>
                    <p class="m-0">
                      Take your web application to the next level with AdminMart's Dashboard templates.
                    </p>
                    <a href="javascript:void(0)" class="text-primary fs-3 mt-3 d-inline-flex">
                      <i class="bi bi-arrow-right-circle"></i>
                    </a>
                ...
                <div class="card mb-3">
                  <div class="p-4">
                    ...
                    <p class="m-0">
                      Your one stop shop for great example dashboards. Includes dashboards for Executives, Reps, Sales,
                      Support and more.
                    </p>
                    <a href="javascript:void(0)" class="text-primary fs-3 mt-3 d-inline-flex">
                      <i class="bi bi-arrow-right-circle"></i>
                ...
                <div class="card bg-info mb-3">
                  <div class="p-4 text-white">
                    <h3 class="display-6 fw-lighter">
                      Bootstrap Admin & Dashboard Themes and Templates.
                    </h3>
                    <p class="m-0">
                      Download Bootstrap 5 Admin & Dashboard themes and templates built or reviewed by the creators of
                      Bootstrap Gallery.
                    </p>
                    <a href="javascript:void(0)" class="text-white fs-3 mt-3 d-inline-flex">
                      <i class="bi bi-arrow-right-circle"></i>
                    </a>
                  </div>
                </div>
