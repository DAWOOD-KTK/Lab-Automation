...
<!-- Mirrored from bootstrapget.com/demos/cube-admin-template/offcanvas.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Feb 2025 22:03:31 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <div class="main-container">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="offcanvas.html" class="active-sub">Offcanvas</a>
                  </li>
                  <li>
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <h5 class="m-0 ms-2 fw-semibold">Offcanvas</h5>
            <!-- Page title ends -->
          ...
          <div class="app-body">
            ...
            <div class="row gx-4">
              <div class="col-sm-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Offcanvas With Link</h5>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasLinkExample"
                      ...
                      <div class="offcanvas-body">
                        ...
                        <div class="stacked-images mb-3">
                          ...
                          <img src="assets/images/user2.png" class="rounded-circle img-5x" alt="Bootstrap Gallery">
                          <img src="assets/images/user3.png" class="rounded-circle img-5x" alt="Bootstrap Gallery">
                          <img src="assets/images/user4.png" class="rounded-circle img-5x" alt="Bootstrap Gallery">
                          <img src="assets/images/user5.png" class="rounded-circle img-5x" alt="Bootstrap Gallery">
                        </div>
              ...
              <div class="col-sm-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Enable Body Scrolling</h5>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-sm-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Enable Body Scroll & Backdrop</h5>
                  </div>
                  <div class="card-body">
                    <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
              ...
              <div class="col-sm-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Static Offcanvas</h5>
                  </div>
                  <div class="card-body">
                    <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
              ...
              <div class="col-sm-3">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Offcanvas Left</h5>
                  </div>
                  <div class="card-body">
                    <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
              ...
              <div class="col-sm-3">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Offcanvas Top</h5>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop"
                      ...
                      <div class="offcanvas-body">
                        ...
                        <div class="d-flex gap-2">
                          <img src="assets/images/user.png" class="img-fluid img-3x rounded-2" alt="Bootstrap Gallery">
                          <img src="assets/images/user1.png" class="img-fluid img-3x rounded-2" alt="Bootstrap Gallery">
                          <img src="assets/images/user2.png" class="img-fluid img-3x rounded-2" alt="Bootstrap Gallery">
                          <img src="assets/images/user3.png" class="img-fluid img-3x rounded-2" alt="Bootstrap Gallery">
                          <img src="assets/images/user4.png" class="img-fluid img-3x rounded-2" alt="Bootstrap Gallery">
                          <img src="assets/images/user5.png" class="img-fluid img-3x rounded-2" alt="Bootstrap Gallery">
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-sm-3">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Offcanvas Right</h5>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-sm-3">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Offcanvas Bottom</h5>
                  </div>
                  <div class="card-body">
